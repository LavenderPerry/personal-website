-- Custom index handler that, in addition to functions performed by the default indexer,
-- creates pages to filter blog posts by tags.
--
-- Source: https://codeberg.org/PataphysicalSociety/soupault-blueprints-blog/src/branch/main/helpers/blog-index.lua
--
